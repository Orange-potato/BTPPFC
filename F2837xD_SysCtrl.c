...
//    (*Device_cal)();
   ...
   //InitSysPll(XTAL_OSC,IMULT_20,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 20Mhz(OSCCLK) * 20 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)
    //InitSysPll(INT_OSC1,IMULT_20,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 10Mhz(OSCCLK) * 20 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)
    //InitSysPll(INT_OSC2,IMULT_30,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 10Mhz(OSCCLK) * 30 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)
    InitSysPll(XTAL_OSC,IMULT_20,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 20Mhz(OSCCLK) * 20 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)
...
void SysIntOsc1Sel (void) {
    EALLOW;
    ClkCfgRegs.CLKSRCCTL1.bit.OSCCLKSRCSEL = 2; // Turn on INTOSC1
